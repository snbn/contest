...
std::vector<size_t> factors(size_t n) {
...
std::vector<std::pair<size_t, size_t>> factorize(size_t n) {
  using std::make_pair;
...
std::vector<bool> eratosthenes_sieve(size_t size) {
...
std::tuple<int64_t, int64_t> chinese_rem(int64_t a1, int64_t a2, int64_t m1,
                                         int64_t m2) {
  using std::tie, std::make_tuple;
...
std::tuple<int64_t, int64_t> chinese_rem(const std::vector<int64_t>& a,
                                         const std::vector<int64_t>& MOD) {
  assert(a.size() == MOD.size());
